    ...
    <div x-data="{ sidebarOpen: window.innerWidth >= 1024 }" class="flex h-screen overflow-hidden">
        ...
        <aside 
            ...
            <nav class="flex-1 overflow-y-auto p-4">
                <ul class="space-y-2">
                    <li>
                        <a href="{{ route('home') }}" class="flex items-center space-x-3 px-4 py-3 text-gray-700 hover:bg-gray-100 hover:text-blue-600 rounded-lg transition duration-200 group">
                            <i class="fa-solid fa-house text-lg group-hover:scale-110 transition-transform"></i>
                            <span class="font-medium">Inicio</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('lostpets.index') }}" class="flex items-center space-x-3 px-4 py-3 text-gray-700 hover:bg-gray-100 hover:text-blue-600 rounded-lg transition duration-200 group">
                            <i class="fa-solid fa-map-pin text-lg group-hover:scale-110 transition-transform"></i>
                            <span class="font-medium">Mascotas Perdidas</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('pets.index') }}" class="flex items-center space-x-3 px-4 py-3 text-gray-700 hover:bg-gray-100 hover:text-blue-600 rounded-lg transition duration-200 group">
                            <i class="fa-solid fa-dog text-lg group-hover:scale-110 transition-transform"></i>
                            <span class="font-medium">Mascotas en Adopción</span>
                        </a>
                    </li>
                    
                    <li class="pt-4 mt-4 border-t border-gray-200">
                        <a href="{{ route('about') }}" class="flex items-center space-x-3 px-4 py-3 text-gray-700 hover:bg-gray-100 hover:text-blue-600 rounded-lg transition duration-200 group">
                    ...
                    <li>
                        <a href="{{ route('contactos') }}" class="flex items-center space-x-3 px-4 py-3 text-gray-700 hover:bg-gray-100 hover:text-blue-600 rounded-lg transition duration-200 group">
                    ...
                    <li class="pt-4 mt-4 border-t border-gray-200">
                        <a href="{{ route('pets.create') }}" class="flex items-center space-x-3 px-4 py-3 bg-orange-500 text-white font-semibold hover:bg-orange-600 rounded-lg transition duration-200 shadow-sm">
                    ...
                    <li>
                        <a href="{{ route('register') }}" class="flex items-center space-x-3 px-4 py-3 bg-green-600 text-white font-semibold hover:bg-green-700 rounded-lg transition duration-200 shadow-sm">
                    ...
                    <div class="flex justify-between items-center h-16">
                        ...
                        <div class="flex items-center gap-3">
                            <button @click="sidebarOpen = !sidebarOpen" 
                                    class="text-gray-600 hover:text-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-lg p-2 transition">
                        ...
                        <div class="hidden md:flex items-center gap-2">
                            <a href="{{ route('about') }}" class="text-gray-700 hover:text-blue-600 px-3 py-2 rounded-md transition font-medium">
                                Acerca de
                            </a>
                            <a href="{{ route('contactos') }}" class="text-gray-700 hover:text-blue-600 px-3 py-2 rounded-md transition font-medium">
                                Contactos
                            </a>
                            <a href="{{ route('pets.index') }}" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition duration-300 font-medium shadow-sm">
                    ...
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div>
                                ...
                                <ul class="space-y-2 text-sm">
                                    ...
                                    <li>
                                        <a href="{{ route('pets.index') }}" class="text-gray-600 hover:text-orange-500 transition">
                                            <i class="fa-solid fa-chevron-right text-xs mr-1"></i>Mascotas en Adopción
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('lostpets.index') }}" class="text-gray-600 hover:text-orange-500 transition">
                                            <i class="fa-solid fa-chevron-right text-xs mr-1"></i>Mascotas Perdidas
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('about') }}" class="text-gray-600 hover:text-orange-500 transition">
                            ...
                            <div>
                                ...
                                <ul class="space-y-3 text-sm">
                                    <li class="flex items-start gap-2 text-gray-600">
                                        ...
                                        <a href="mailto:{{ config('mail.from.address') }}" class="hover:text-orange-500 transition">
                                    ...
                                    <li>
                                        <a href="{{ route('contactos') }}" class="inline-block bg-orange-500 text-white px-4 py-2 rounded-lg hover:bg-orange-600 transition text-sm font-medium">
                        ...
                        <div class="border-t border-gray-200 mt-8 pt-6 text-center">
                            <p class="text-sm text-gray-500">
                                © {{ date('Y') }} Petbook. Hecho con <i class="fa-solid fa-heart text-red-500"></i> para los amantes de las mascotas.
                            </p>
                        </div>
                    </div>
                </footer>
